...
> = {
  "row-1-col-1": { top: "8%", right: "24%" },
  "row-1-col-2": { top: "8%", right: "4%" },
  "row-2-col-1": { top: "38%", right: "24%" },
  "row-2-col-2": { top: "38%", right: "6%" },
  "row-3-col-1": { top: "68%", right: "24%" },
  "row-3-col-2": { top: "68%", right: "4%" },
  "row-4-col-1": { top: "52%", right: "32%" },
  "row-4-col-2": { top: "52%", right: "2%" },
};
...
export const DesktopParallaxHeroImages = ({
  images,
  className,
  imageClassName,
  variant = "default",
